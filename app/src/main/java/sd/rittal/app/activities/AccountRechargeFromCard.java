...
public class AccountRechargeFromCard extends AppCompatActivity implements FormSession,LoginSession {
    ...
    private void cardRecharge(String pan , final String exdate, String ipin , String amount ) {
...
//         ipin_ = IPINBlockGenerator.getIPINBlock(ipin,"MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJ4HwthfqXiK09AgShnnLqAqMyT5VUV0hvSdG+ySMx+a54Ui5EStkmO8iOdVG9DlWv55eLBoodjSfd0XRxN7an0CAwEAAQ==",uuid);;
    ...
    private void initiateLayout(){
        ...
        btn_recharge                = (Button) findViewById(R.id.btn_rechargeAccount);
        ...
        toolbar.setTitle(getString(R.string.account_recharge));
        ...
        btn_recharge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(validation(pan,expiry_date,ipin,amount)){
                    clearForm();
                    cardRecharge(pan,expiry_date,ipin,amount);
                }
            }
        });
