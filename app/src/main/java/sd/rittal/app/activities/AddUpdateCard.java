...
public class AddUpdateCard extends AppCompatActivity implements FormSession,LoginSession {
    Activity activity;
    Rittal rittal;
    ...
    EditText et_card_name,et_card_pan,et_card_expiry_date;
    Button btn_add_update;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_update_card);
    ...
    public void initLayout(){
        ...
        layout_selected_color   = (LinearLayout)findViewById(R.id.layout_selected_color);
...
//        createDialogWithoutDateField().show();
    ...
    public void setCardDataToUpdate(){
        ...
        et_card_name.setText(card_name);
        et_card_pan.setText(card_pan);
        et_card_expiry_date.setText(card_expiry_date);
        layout_selected_color.getBackground().setColorFilter(mSelectedColor, PorterDuff.Mode.SRC_ATOP);
    }
    ...
    public Boolean isValidate(){
        ...
        String exDate   = et_card_expiry_date.getText().toString().trim();
    ...
    public void add(){
        ...
        if(isValidate()){
            String name     = et_card_name.getText().toString().trim();
            String pan      = et_card_pan.getText().toString().trim().replace(" ","");
            String formatedExDate   = et_card_expiry_date.getText().toString().trim();
    ...
    public void update(){
        if(isValidate()){
            String name     = et_card_name.getText().toString().trim();
            String pan      = et_card_pan.getText().toString().trim();
            String exDate   = et_card_expiry_date.getText().toString().trim();
