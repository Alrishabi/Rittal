...
public class BillInquiryActivity extends AppCompatActivity implements FormSession,LoginSession {

    String TAG = BillInquiryActivity.class.getSimpleName().toUpperCase();
    Activity activity;
    Rittal rittal;
    ...
    EditText et_card_pan,et_card_expiry_date,et_card_pin,et_service_provider,et_phone_number;
    ...
    private void initiateLayout(){
        ...
        toolbar.setTitle(getString(R.string.title_bill_iquery));
...
//        createDialogWithoutDateField().show();
        ...
        btn_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(validation(pan,expiry_date,pin,service_provider_id,phone_number)){
                    clearForm();
                    billInquiry(pan,expiry_date,pin,service_provider_id,phone_number);
                }
...
//                      rittal.rittalToast(cNumber,"0","i");
    ...
    private boolean validation(String pan , String expiry_date , String pin , String service_provider_id , String phone_number){
        ...
        if(!expiry_date.equals("ACCC")){
            ...
            if(pan.length() == 0 || expiry_date.length() == 0  || pin.length() == 0 || service_provider_id.length() == 0|| phone_number.length() ==0){
                ...
                if(service_provider_id.trim().equals("")){rittal.rittalToast(getString(R.string.select_provider),"1","w");return false;}
            ...
            if( service_provider_id.length() == 0|| phone_number.length() ==0){
                if(service_provider_id.trim().equals("")){rittal.rittalToast(getString(R.string.select_provider),"1","w");return false;}
                if(phone_number.length() == 0){rittal.rittalToast(getString(R.string.enter_phone_number),"1","w");return false;}
                return false;
            }else{
    ...
    private void billInquiry(String pan , final String exdate , String ipin, final String provider_id, String phone) {
        ...
        // ?service=4&cust_id=1&pan="+Uri.encode(pan)+"&ex_date="+Uri.encode(exdate)+
        // "&ipin="+Uri.decode(ipin_)+"&uuid="+Uri.encode(uuid)+"&opid="+Uri.encode(provider_id)+
...
"balance":null,
"billInfo":"{totalAmount:\"297.33\",billedAmount:\"171.79\",lastInvoiceDate:\"2019-02-28\",contractNumber:\"24152931\",last4Digits:\"5972\",unbilledAmount:\"125.54\"}",
"payeesCount":0,
"respUserName":null,
"responseMessageArabic":null,
"responseCode":0,"financialInstitutionId":null,
"originalTranType":null,"voucherCode":null,
"originalTranUUID":null,"resp_tranAmount":0,
"resp_issuerTranFee":0,"pubKeyValue":null,
"serviceInfo":null,"RespIPIN":null,
"tranDateTime":"100319204619",
"creationDate":null,"respUUID":null,
"responseStatus":"Successful",
"RespExpDate":null,
"originalTransaction":null,"RespVoucherNumber":null
