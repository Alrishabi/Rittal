...
public class GenerateVoucherActivity extends AppCompatActivity implements FormSession,LoginSession {
    ...
    EditText et_card_pan,et_card_expiry_date,et_card_pin,et_voucher_num,et_amount;
    Button btn_request;
...
//        createDialogWithoutDateField().show();
        ...
        btn_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String voucher_number           = et_voucher_num.getText().toString().trim();
                String amount                   = et_amount.getText().toString().trim();


                if(validation(pan,expiry_date,pin,voucher_number,amount)){
                    clearForm();
                    doGenerateVoucher(pan,expiry_date,pin,voucher_number,amount);
                }
    ...
    private boolean validation(String pan , String expiry_date , String ipin ,String voucher_number, String amount){
        ...
        if(!expiry_date.equals("ACCC")){
            ...
            if(pan.length() == 0 || expiry_date.length() == 0  || ipin.length() == 0 ||  amount.length() ==0 || voucher_number.length() == 0){
                ...
                if(voucher_number.length() == 0){rittal.rittalToast(getString(R.string.enter_voucher_number),"1","w"); return false;}
                ...
                if(pan.length() == 16 || pan.length() == 19){
                    if(expiry_date.length() == 4){
                        if(ipin.length() == 4){
                            if(voucher_number.length() >= 10){
                                return true;
                            }else{
                                rittal.rittalToast(getString(R.string.voucher_number_length),"1","w");
                                return false;
                            }
    ...
    private void doGenerateVoucher(String pan , final String exdate , String ipin,String voucher_number, String amount) {
