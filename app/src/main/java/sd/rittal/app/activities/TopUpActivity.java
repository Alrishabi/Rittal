...
public class TopUpActivity extends AppCompatActivity implements FormSession,LoginSession {

    private static final int PICK_CONTACT =1 ;
    String cNumber="";
    String TAG = TopUpActivity.class.getSimpleName().toUpperCase();
    Activity activity;
    Rittal rittal;
    ...
    private void initiateLayout(){
        ...
        toolbar.setTitle(getString(R.string.title_top_up));
                    ...
                    new AlertDialog.Builder(activity)
                            ...
                            .setPositiveButton(activity.getResources().getString(R.string.yes),new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    clearForm();
                                    doTopUp(pan,expiry_date,pin,service_provider_id,phone_number,amount);                                }
                            })
...
//                      rittal.rittalToast(cNumber,"0","i");
                    ...
                    if(expiry_date.length() == 4){
                        if(pin.length() == 4){
                            if(!service_provider_id.equals("0") || !service_provider_id.equals("")){
                                ...
                                rittal.rittalToast(getString(R.string.card_service_provider_unselected)+" - "+service_provider_id,"1","w");
                                return false;
                            }
                        }else{
    ...
    private void doTopUp(String pan , final String exdate , String ipin, final String provider_id, String phone, String amount) {
        ...
        //?service=6&cust_id=1&pan="+ Uri.encode(pan)+"&ex_date="+Uri.encode(exdate)+"
        // &ipin="+Uri.decode(ipin_)+"&uuid="+Uri.encode(uuid)+"
        // &opid="+Uri.encode(provider_id)+"&payment_info="+Uri.encode(phone)+"&tranAmount="+Uri.encode(amount);
        rittal.log("pubKeyValue",pk);
        rittal.log("URL",url);
        rittal.log("ipin",text);
        final String service = "6";
...
"pubKeyValue":null,"tranDateTime":"190319014419",
"creationDate":null,"panCategory":null,"balance":"{leger:8.4,available:8.4}",
"payeesCount":0,"payeesList":null,"billInfo":"","RespPAN":null,"RespExpDate":null,
"RespIPIN":null,"regType":null,"financialInstitutionId":null,"respUserName":null,
"respUserPassword":null,"RespVoucherNumber":null,"voucherCode":null,
"serviceInfo":null,"originalTransaction":null,"originalTranType":null,
"originalTranUUID":null,"respUUID":null,"resp_acqTranFee":0,
"resp_issuerTranFee":0,"resp_fromAccount":null,
...
"pubKeyValue":null,"tranDateTime":"290719134008","creationDate":null,"panCategory":null,"balance":null,"payeesCount":0,
"payeesList":null,"billInfo":null,"RespPAN":null,"RespExpDate":null,"RespIPIN":null,"regType":null,"financialInstitutionId":null,
...
"resp_issuerTranFee":0,"resp_fromAccount":null,"resp_accountCurrency":null,"resp_tranAmount":0,"resp_paymentInfo":null,
