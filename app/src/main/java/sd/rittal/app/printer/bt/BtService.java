package sd.rittal.app.printer.bt;
...
import sd.rittal.app.printer.BlueToothService;
import sd.rittal.app.printer.BlueToothService.OnReceiveDataHandleEvent;
...
public class BtService extends PrintService implements PrinterClass {
	...
	public boolean printUnicode(String textStr) {
		...
		String temp = textStr.substring(0,textStr.length())  + textStr.charAt(0);
		temp +="\r\n";
		temp=textStr;
		// TODO Auto-generated method stub
